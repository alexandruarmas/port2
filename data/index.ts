...
export const projects = [
  ...
  {
    id: 3,
    title: "O aplicație web modernă care simulează experiența desktop macOS,Construită cu Next.js și React.",
    des: "Experimentați designul elegant și funcționalitatea macOS chiar în browserul dvs.",
    img: getImagePath("/macbooc.png"),
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg", "/three.svg", "/c.svg"].map(icon => getImagePath(icon)),
    link: "https://alexandruarmas.github.io/makbook-simulator/",
    sourceCode: "https://github.com/alexandruarmas/makbook-simulator",
  },
  {
    id: 4,
    title: "Pagina de profil GitHub",
    des: "O pagină de profil GitHub personalizată cu funcții interne și funcții de social media, construită cu Next.js și React.",
    img: getImagePath("/teku-preview.png"),
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/stream.svg", "/c.svg"].map(icon => getImagePath(icon)),
    link: "https://github.com/mrarmas02/mrarmas02",
    sourceCode: "https://github.com/mrarmas02/mrarmas02",
  },
] as const;
